...
def build_report():
    ...
    c.drawString(x, y, "NIT Jamshedpur — AI Interview Features & Market Comparison")
    y -= 0.4 * inch
    ...
    c.setFont("Helvetica", 10)
    files = [
        "NIT Jamshedpur/AI/services.py — LLM prompts, feedback generation, hint/rephrase",
        "NIT Jamshedpur/AI/views.py — interview lifecycle, STT endpoint, feedback endpoints, PDF generation",
        "NIT Jamshedpur/AI/models.py — InterviewSession and InterviewMessage storage",
    ...
    c.setFont("Helvetica-Bold", 12)
    c.drawString(x, y, "6. How NIT Jamshedpur Stands Out")
    y -= 0.25 * inch
    c.setFont("Helvetica", 10)
    outs = [
